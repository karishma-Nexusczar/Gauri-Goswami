...
async function processHeroLeftImage() {
  const inputPath = path.join(__dirname, 'public', 'hero-left-formal.png');
  ...
  if (fs.existsSync(aiGeneratedPath)) {
    const aiDest = path.join(__dirname, 'public', 'hero-left-ai-dark.png');
  ...
  const outputPath = path.join(__dirname, 'public', 'hero-left-formal-dark.png');
  ...
  const originalPath = path.join(__dirname, 'public', 'hero-left-original.png');
